"""
Django settings for addrew-test-repo-create project.
...
APP_NAME = os.getenv("APP_NAME", "addrew-test-repo-create")
...
MIDDLEWARE = [
    'addrew-test-repo-create.middleware.healthcheckmiddleware.HealthCheckMiddleware',
    ...
    'addrew-test-repo-create.middleware.metricsmiddleware.MetricsMiddleware',
]

ROOT_URLCONF = 'addrew-test-repo-create.urls'
...
WSGI_APPLICATION = 'addrew-test-repo-create.wsgi.application'
